...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1164.7998807246; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -998.3998977639; // x position of the perpendicular encoder (in tick units)
    }
