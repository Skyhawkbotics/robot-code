...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 665.5999318; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 332.7999659; // x position of the perpendicular encoder (in tick units)
    }
