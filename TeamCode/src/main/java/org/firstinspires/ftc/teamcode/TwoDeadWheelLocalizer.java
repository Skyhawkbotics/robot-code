...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 559.863; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -274.7347430; // x position of the perpendicular encoder (in tick units)
    }
